...
const JobDetails = () => {
    ...
    const handlePlaceBid = async e => {
        ...
        try {
            axios.post(`${import.meta.env.VITE_server_Url}/bids`, bidData)
                .then(res => {
                    console.log(res.data);
                    if (res.data.insertedId) {
                        Swal.fire({
                            icon: "success",
                            title: "Your bid is added successfully.",
                ...
                <form onSubmit={handlePlaceBid}>
                    <div className='grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2'>
                        ...
                        <div className='flex flex-col gap-2 '>
                            ...
                            <DatePicker className="w-full p-2 border rounded-md" selected={startDate} onChange={(date) => setStartDate(date)} />
                        </div>
                    </div>
